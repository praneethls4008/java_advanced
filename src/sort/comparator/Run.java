...
import sort.comparator.Bike;
import sort.comparator.Car;
...
public class Run {
	...
	public static <T> void sortList() {
        ...
        List<Bike> bikes = Arrays.asList(
		 ...
		 // Comparator for Cars
        Comparator<Car> sortCarsByPrice = new Comparator<>() {
            @Override
        ...
        // Comparator for Bikes
        Comparator<Bike> sortBikesByPrice = new Comparator<>() {
            @Override
        ...
        Collections.sort(cars, sortCarsByPrice);
        System.out.println("Cars sorted by price:");
        cars.forEach(System.out::println);

        Collections.sort(bikes, sortBikesByPrice);
        System.out.println("\nBikes sorted by price:");
        bikes.forEach(System.out::println);
        
        Collections.sort(bikes, (Bike b1, Bike b2) -> Integer.compare(b1.getCc(), b2.getCc()));
        System.out.println("\nBikes sorted by cc:");
        bikes.forEach(System.out::println);
